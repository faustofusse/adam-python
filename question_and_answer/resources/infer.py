...
from .utils import import_packages, parse_config
from .chainer import Chainer
from .params import from_params
    ...
    for component_config in model_config['pipe']:
        if load_trained and ('fit_on' in component_config or 'in_y' in component_config):
            try:
                ...
                print('No "save_path" parameter for the {} component, so "load_path" will not be renewed'
